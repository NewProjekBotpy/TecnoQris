...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ...
      {...props}
    >
      <SheetPrimitive.Close className="absolute right-3 top-3 z-[100] rounded-full p-2 bg-secondary hover:bg-destructive/20 hover:text-destructive ring-offset-background focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none transition-colors touch-manipulation" data-testid="button-close-sidebar">
        <X className="h-5 w-5" />
